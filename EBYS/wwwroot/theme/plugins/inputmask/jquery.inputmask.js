...
!function webpackUniversalModuleDefinition(root, factory) {
    ...
    return modules = [ function(module) {
        ...
        }, Inputmask.extenBusinessiases = function(alias) {
                        ...
                        if (void 0 !== match.matches) {
                            if (match.isGroup && quantifierRecurse !== match) {
                                ...
                                if (-1 === altIndex || "string" == typeof altIndex) {
                                    ...
                                    for (var unMatcheBusinessternation = !1, ndx = 0; ndx < altIndexArr.length; ndx++) {
                                        amndx = parseInt(altIndexArr[ndx]), matches = [], ndxInitializer = "string" == typeof altIndex && resolveNdxInitializer(testPos, amndx, loopNdxCnt) || ndxInitializerClone.slice(), 
                                        alternateToken.matches[amndx] && handleMatch(alternateToken.matches[amndx], [ amndx ].concat(loopNdx), quantifierRecurse) ? match = !0 : 0 === ndx && (unMatcheBusinessternation = !0), 
                                        maltMatches = matches.slice(), testPos = currentPos, matches = [];
                                        for (var ndx1 = 0; ndx1 < maltMatches.length; ndx1++) {
                                            var altMatch = maltMatches[ndx1], dropMatch = !1;
                                            altMatch.match.jit = altMatch.match.jit || unMatcheBusinessternation, altMatch.alternation = altMatch.alternation || loopNdxCnt, 
